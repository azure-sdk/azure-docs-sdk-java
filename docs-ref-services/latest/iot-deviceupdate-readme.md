...
---
# Azure Device Update for IoT Hub client library for Java - version 1.0.31 


The library provides access to the Device Update for IoT Hub service that enables customers to publish updates for their IoT devices to the cloud, and then deploy these updates to their devices (approve updates to groups of devices managed and provisioned in IoT Hub).

  [Source code](https://github.com/Azure/azure-sdk-for-java/tree/azure-iot-deviceupdate_1.0.31/sdk) | [Product documentation](/azure/iot-hub-device-update/understand-device-update)
...
You can familiarize yourself with different APIs using [Samples](https://github.com/Azure/azure-sdk-for-java/tree/azure-iot-deviceupdate_1.0.31/sdk/deviceupdate/azure-iot-deviceupdate/src/samples).
...
Get started with our [Device Update for IoT Hub samples](https://github.com/Azure/azure-sdk-for-java/tree/azure-iot-deviceupdate_1.0.31/sdk/deviceupdate/azure-iot-deviceupdate/src/samples)
