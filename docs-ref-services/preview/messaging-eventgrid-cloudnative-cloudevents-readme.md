...
keywords: Azure, java, SDK, API, azure-messaging-eventgrid-cloudnative-cloudevents, azure-event-grid
ms.date: 08/14/2024
ms.topic: reference
ms.devlang: java
ms.service: azure-event-grid
---
# Azure Cloud Native Cloud Event client library for Java - version 1.0.0-alpha.20240814.1 
