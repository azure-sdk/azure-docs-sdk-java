...
ms.service: template
---
# Azure Template Three client library for Java - version 1.0.0-alpha.20240418.11 
...
* Example: `# Azure Batch client library for Java - version 1.0.0-alpha.20240418.11 
`
