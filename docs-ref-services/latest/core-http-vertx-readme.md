...
ms.service: core
---
# Azure Core Vert.x HTTP plugin library for Java - version 1.1.7 
...
To learn more about the BOM, see the [AZURE SDK BOM README](https://github.com/Azure/azure-sdk-for-java/blob/com.azure+azure-core-http-vertx_1.1.7/sdk/boms/azure-sdk-bom/README.md).
...
For details on contributing to this repository, see the [contributing guide](https://github.com/Azure/azure-sdk-for-java/blob/com.azure+azure-core-http-vertx_1.1.7/CONTRIBUTING.md).
