...
ms.service: core
---
# Azure Core JDK HTTP plugin library for Java - version 1.1.1 
...
To learn more about the BOM, see the [AZURE SDK BOM README](https://github.com/Azure/azure-sdk-for-java/blob/azure-core-http-jdk-httpclient_1.1.1/sdk/boms/azure-sdk-bom/README.md).
...
For details on contributing to this repository, see the [contributing guide](https://github.com/Azure/azure-sdk-for-java/blob/azure-core-http-jdk-httpclient_1.1.1/CONTRIBUTING.md).
