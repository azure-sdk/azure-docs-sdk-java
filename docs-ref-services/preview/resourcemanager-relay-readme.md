...
keywords: Azure, java, SDK, API, azure-resourcemanager-relay, service-bus-relay
ms.date: 05/02/2024
ms.topic: reference
ms.devlang: java
ms.service: service-bus-relay
---
# Azure Resource Manager Relay client library for Java - version 1.0.0-alpha.20240501.1 
