...
ms.service: core
---
# Azure Core Management client library for Java - version 1.19.1 
...
For details on contributing to this repository, see the [contributing guide](https://github.com/Azure/azure-sdk-for-java/blob/azure-core-management_1.19.1/CONTRIBUTING.md).
