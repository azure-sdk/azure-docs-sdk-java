...
ms.service: core
---
# Azure Core shared library for Java - version 1.58.0 
...
the [AZURE SDK BOM README](https://github.com/Azure/azure-sdk-for-java/blob/com.azure+azure-core_1.58.0/sdk/boms/azure-sdk-bom/README.md).
...
the [contributing guide](https://github.com/Azure/azure-sdk-for-java/blob/com.azure+azure-core_1.58.0/CONTRIBUTING.md).
