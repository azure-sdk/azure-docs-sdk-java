...
ms.service: core
---
# Azure Core Netty HTTP plugin library for Java - version 1.16.2 
...
To learn more about the BOM, see the [AZURE SDK BOM README](https://github.com/Azure/azure-sdk-for-java/blob/azure-core-http-netty_1.16.2/sdk/boms/azure-sdk-bom/README.md).
...
For details on contributing to this repository, see the [contributing guide](https://github.com/Azure/azure-sdk-for-java/blob/azure-core-http-netty_1.16.2/CONTRIBUTING.md).
