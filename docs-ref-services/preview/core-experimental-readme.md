...
ms.service: core
---
# Azure Core Experimental shared library for Java - version 1.0.0-beta.69 
...
For details on contributing to this repository, see the [contributing guide](https://github.com/Azure/azure-sdk-for-java/blob/com.azure+azure-core-experimental_1.0.0-beta.69/CONTRIBUTING.md).
