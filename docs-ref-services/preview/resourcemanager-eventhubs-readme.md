...
keywords: Azure, java, SDK, API, azure-resourcemanager-eventhubs, event-hubs
ms.date: 03/26/2024
ms.topic: reference
ms.devlang: java
ms.service: event-hubs
---
# Azure Resource Manager EventHubs client library for Java - version 2.38.0-alpha.20240325.1 
