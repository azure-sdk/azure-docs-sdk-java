...
ms.service: core
---
# Azure Core AMQP shared library for Java - version 2.10.0 
...
To learn more about the BOM, see the [AZURE SDK BOM README](https://github.com/Azure/azure-sdk-for-java/blob/azure-core-amqp_2.10.0/sdk/boms/azure-sdk-bom/README.md).
...
For details on contributing to this repository, see the [contributing guide](https://github.com/Azure/azure-sdk-for-java/blob/azure-core-amqp_2.10.0/CONTRIBUTING.md).
