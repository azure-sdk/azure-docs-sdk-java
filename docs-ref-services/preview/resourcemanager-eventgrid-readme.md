...
keywords: Azure, java, SDK, API, azure-resourcemanager-eventgrid, event-grid
ms.date: 03/20/2024
ms.topic: reference
ms.devlang: java
ms.service: event-grid
---
# Azure Resource Manager EventGrid client library for Java - version 1.2.0-alpha.20240319.1 


Azure Resource Manager EventGrid client library for Java.

This package contains Microsoft Azure SDK for EventGrid Management SDK. Azure EventGrid Management Client. Package tag package-2023-12-preview. For documentation on how to use this package, please see [Azure Management Libraries for Java](https://aka.ms/azsdk/java/mgmt).
