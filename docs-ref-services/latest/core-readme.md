...
ms.service: core
---
# Azure Core shared library for Java - version 1.57.1 
...
the [AZURE SDK BOM README](https://github.com/Azure/azure-sdk-for-java/blob/azure-core_1.57.1/sdk/boms/azure-sdk-bom/README.md).
...
the [contributing guide](https://github.com/Azure/azure-sdk-for-java/blob/azure-core_1.57.1/CONTRIBUTING.md).
