...
ms.service: ai
---
# Azure VoiceLive client library for Java - version 1.0.0-beta.1 
...
[azure_identity]: https://github.com/Azure/azure-sdk-for-java/blob/azure-ai-voicelive_1.0.0-beta.1/sdk/identity/azure-identity
